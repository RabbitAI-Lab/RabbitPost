...
import { Layout, Menu, Select, Spin, Tag } from "antd";
...
export default function ConsoleLayout() {
  ...
  const { orgs, currentOrgId, bootstrapped, bootstrap, selectOrg } =
    useConsoleStore();
  ...
  if (orgs.length === 0) {
    return (
      <div style={{ height: "100%", display: "grid", placeItems: "center", flexDirection: "column", gap: 16 }}>
        <BankOutlined style={{ fontSize: 48, color: "#ff6c37" }} />
        <p style={{ color: "#666" }}>您还没有加入任何企业组织</p>
        <Link to="/">
